...
public class Add extends AppCompatActivity {
    ...
    private String namefood, namechef, bahan,langkah, timeStamp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Tambah Resep");
    ...
    private void getData() {
        ...
        long id = dbHelper.insertInfo(nmfood, nmchef, bahan,step, ""+imageUri, timeStamp, timeStamp);
        doToast("Record Added Succesfully ");
        empty();
    }
